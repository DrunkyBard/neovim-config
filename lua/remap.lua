...
vim.keymap.set('n', '<C-M-left>', '<C-w>h', { desc = 'clear selection' })
vim.keymap.set('n', '<C-M-right>', '<C-w>l', { desc = 'clear selection' })
vim.keymap.set('n', '<C-M-down>', '<C-w>j', { desc = 'clear selection' })
vim.keymap.set('n', '<C-M-up>', '<C-w>k', { desc = 'clear selection' })
