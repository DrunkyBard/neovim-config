...
vim.keymap.set('n', '<S-M-h>', ':vertical resize -2<cr>', { desc = 'Vertical left border resize' })
vim.keymap.set('n', '<S-M-l>', ':vertical resize +2<cr>', { desc = 'Vertical right border resize' })
...
vim.keymap.set('n', '<M-left>', '<C-w>h', { desc = 'Select left window' })
vim.keymap.set('n', '<M-h>', '<C-w>h', { desc = 'Select left window' })
vim.keymap.set('n', '<M-right>', '<C-w>l', { desc = 'Select right window' })
vim.keymap.set('n', '<M-l>', '<C-w>l', { desc = 'Select right window' })
vim.keymap.set('n', '<M-down>', '<C-w>j', { desc = 'Select bottom window' })
vim.keymap.set('n', '<M-j>', '<C-w>j', { desc = 'Select bottom window' })
vim.keymap.set('n', '<M-up>', '<C-w>k', { desc = 'Select top window' })
vim.keymap.set('n', '<M-k>', '<C-w>k', { desc = 'Select top window' })
